...
@patch("weenspace.csv.utils.export.create_file_with_headers")
@patch("weenspace.csv.utils.export.export_products_in_batches")
@patch("weenspace.csv.utils.export.send_export_download_link_notification")
@patch("weenspace.csv.utils.export.save_csv_file_in_export_file")
...
@patch("weenspace.plugins.manager.PluginsManager.product_export_completed")
...
@patch("weenspace.csv.utils.export.create_file_with_headers")
@patch("weenspace.csv.utils.export.export_gift_cards_in_batches")
@patch("weenspace.csv.utils.export.send_export_download_link_notification")
@patch("weenspace.csv.utils.export.save_csv_file_in_export_file")
...
@patch("weenspace.plugins.manager.PluginsManager.gift_card_export_completed")
...
@patch("weenspace.csv.utils.export.BATCH_SIZE", 1)
...
@patch("weenspace.csv.utils.export.create_file_with_headers")
@patch("weenspace.csv.utils.export.export_voucher_codes_in_batches")
@patch("weenspace.csv.utils.export.send_export_download_link_notification")
@patch("weenspace.csv.utils.export.save_csv_file_in_export_file")
...
@patch("weenspace.plugins.manager.PluginsManager.voucher_code_export_completed")
