...
@mock.patch("weenspace.plugins.manager.PluginsManager.gift_card_export_completed")
@mock.patch("weenspace.plugins.manager.PluginsManager.product_export_completed")
