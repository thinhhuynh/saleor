...
@patch(
    "weenspace.order.calculations.update_order_prices_with_flat_rates",
...
@patch("weenspace.order.calculations.fetch_order_prices_if_expired")
...
@patch("weenspace.plugins.manager.PluginsManager.calculate_order_line_total")
@patch("weenspace.plugins.manager.PluginsManager.get_taxes_for_order")
...
@patch("weenspace.plugins.manager.PluginsManager.calculate_order_total")
@patch("weenspace.plugins.manager.PluginsManager.get_taxes_for_order")
@patch("weenspace.order.calculations._apply_tax_data")
@override_settings(PLUGINS=["weenspace.plugins.tests.sample_plugins.PluginSample"])
