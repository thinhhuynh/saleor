...
@patch(
    "weenspace.order.actions.send_fulfillment_confirmation_to_customer",
    wraps=send_fulfillment_confirmation_to_customer,
)
@patch(
    "weenspace.order.actions.send_payment_confirmation", wraps=send_payment_confirmation
)
@patch("weenspace.plugins.manager.PluginsManager.fulfillment_created")
...
@patch("weenspace.order.actions.send_payment_confirmation")
...
@patch("weenspace.order.notifications.send_payment_confirmation")
...
@patch("weenspace.giftcard.utils.send_gift_card_notification")
@patch("weenspace.order.actions.send_payment_confirmation")
...
@patch("weenspace.order.actions.send_order_canceled_confirmation")
...
@patch("weenspace.plugins.manager.PluginsManager.order_refunded")
@patch("weenspace.plugins.manager.PluginsManager.order_fully_refunded")
@patch("weenspace.order.actions.send_order_refunded_confirmation")
...
@patch("weenspace.order.actions.send_fulfillment_confirmation_to_customer")
@patch("weenspace.order.utils.get_default_digital_content_settings")
@patch("weenspace.plugins.manager.PluginsManager.fulfillment_created")
...
@patch("weenspace.plugins.manager.PluginsManager.order_updated")
@patch("weenspace.plugins.manager.PluginsManager.order_fully_paid")
