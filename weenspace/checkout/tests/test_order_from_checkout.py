...
def test_note_in_created_order_checkout_line_deleted_in_the_meantime(
    ...
    with before_after.after(
        "weenspace.checkout.complete_checkout._increase_voucher_code_usage_value",
...
@mock.patch("weenspace.checkout.calculations.checkout_line_total")
@mock.patch("weenspace.checkout.calculations.checkout_line_unit_price")
