...
def test_install_app_created_app_with_audience(
    ...
    monkeypatch.setattr("weenspace.app.installation_utils.send_app_token", Mock())
...
def test_install_app_with_brand_data(app_manifest, app_installation, monkeypatch):
    ...
    monkeypatch.setattr(
        "weenspace.app.installation_utils.fetch_brand_data_task.delay",
...
@patch("weenspace.plugins.webhook.plugin.get_webhooks_for_event")
...
@patch("weenspace.app.installation_utils.validate_icon_image")
...
@patch("weenspace.app.installation_utils.fetch_icon_image")
...
@patch("weenspace.app.installation_utils.AppInstallation.save", side_effect=DatabaseError)
@patch("weenspace.app.installation_utils.default_storage.delete")
@patch("weenspace.app.installation_utils.fetch_icon_image")
