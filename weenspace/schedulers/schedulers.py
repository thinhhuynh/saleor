...
def setup_celery_logging(loglevel=None, **_kwargs):
    ...
    """
    logging.getLogger("weenspace.schedulers").setLevel(loglevel)
...
class PersistentScheduler(celery.beat.PersistentScheduler, BaseScheduler):
    ...
    Usage:
    $ celery --app weenspace.celeryconf:app beat \
        --scheduler weenspace.schedulers.schedulers.PersistentScheduler
    """
...
class DatabaseScheduler(BaseDatabaseScheduler, BaseScheduler):
    ...
    Usage:
    $ celery --app weenspace.celeryconf:app beat \
        --scheduler weenspace.schedulers.schedulers.DatabaseScheduler
    """
