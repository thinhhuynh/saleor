...
@patch("weenspace.discount.tasks.clear_promotion_rule_variants_task.delay")
@patch(
    "weenspace.discount.tasks.mark_catalogue_promotion_rules_as_dirty",
    wraps=mark_catalogue_promotion_rules_as_dirty,
)
@patch("weenspace.plugins.manager.PluginsManager.sale_toggle")
@patch("weenspace.plugins.manager.PluginsManager.promotion_ended")
@patch("weenspace.plugins.manager.PluginsManager.promotion_started")
