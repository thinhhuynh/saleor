...
@patch("weenspace.discount.utils.base_checkout_delivery_price")
@patch("weenspace.discount.utils.base_checkout_subtotal")
...
def test_create_discount_objects_for_order_promotions_race_condition(
    ...
    with before_after.before(
        "weenspace.discount.utils.create_checkout_discount_objects_for_order_promotions",
...
def test_create_or_update_order_discount_race_condition(
    ...
    with before_after.before(
        "weenspace.discount.utils._set_checkout_base_prices", call_update
    ):
        call_update()
...
def test_create_checkout_line_discount_objects_for_catalogue_promotions_race_condition(
    ...
    with before_after.before(
        "weenspace.discount.utils.prepare_line_discount_objects_for_catalogue_promotions",
