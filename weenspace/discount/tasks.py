...
@app.task(
    name="weenspace.discount.migrations.tasks.saleor3_17.update_discounted_prices_task"
)
...
@app.task(
    name="weenspace.discount.migrations.tasks.saleor3_17.set_promotion_rule_variants"
)
