...
@patch("weenspace.warehouse.availability.check_preorder_threshold_in_orders")
@patch("weenspace.warehouse.availability.check_stock_quantity")
...
@patch("weenspace.warehouse.availability.check_preorder_threshold_bulk")
@patch("weenspace.warehouse.availability.check_stock_quantity_bulk")
