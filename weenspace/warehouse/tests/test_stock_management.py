...
@mock.patch("weenspace.plugins.manager.PluginsManager.product_variant_back_in_stock")
...
@mock.patch("weenspace.plugins.manager.PluginsManager.product_variant_out_of_stock")
