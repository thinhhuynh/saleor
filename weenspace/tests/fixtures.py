...
def site_settings(db, settings) -> SiteSettings:
    ...
    weenspace.site.models.SiteSettings have a one-to-one relationship and a site
...
def voucher_percentage(channel_USD):
    ...
    VoucherCode.objects.create(code="weenspace", voucher=voucher)
    VoucherChannelListing.objects.create(
        voucher=voucher,
        channel=channel_USD,
        discount_value=10,
...
def payment_app(db, permission_manage_payments):
    app = App.objects.create(
        name="Payment App", is_active=True, identifier="weenspace.payment.test.app"
    )
...
def list_stored_payment_methods_app(db, permission_manage_payments):
    app = App.objects.create(
        ...
        is_active=True,
        identifier="weenspace.payment.app.list.stored.method",
    )
    app.tokens.create(name="Default")
    app.permissions.add(permission_manage_payments)
...
def stored_payment_method_request_delete_app(db, permission_manage_payments):
    app = App.objects.create(
        ...
        is_active=True,
        identifier="weenspace.payment.app.payment.method.request.delete",
    )
    app.tokens.create(name="Default")
    app.permissions.add(permission_manage_payments)
...
def payment_gateway_initialize_tokenization_app(db, permission_manage_payments):
    app = App.objects.create(
        name="Payment method request delete",
        is_active=True,
        identifier="weenspace.payment.app.payment.gateway.initialize.tokenization",
    )
    app.tokens.create(name="Default")
    app.permissions.add(permission_manage_payments)
...
def payment_method_initialize_tokenization_app(db, permission_manage_payments):
    app = App.objects.create(
        ...
        is_active=True,
        identifier="weenspace.payment.app.payment.method.initialize.tokenization",
    )
    app.tokens.create(name="Default")
    app.permissions.add(permission_manage_payments)
...
def payment_method_process_tokenization_app(db, permission_manage_payments):
    app = App.objects.create(
        ...
        is_active=True,
        identifier="weenspace.payment.app.payment.method.process.tokenization",
    )
    app.tokens.create(name="Default")
    app.permissions.add(permission_manage_payments)
