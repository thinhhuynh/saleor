...
@override_settings(MAX_USER_ADDRESSES=2)
@patch("weenspace.account.utils.remove_the_oldest_user_address")
...
@patch("weenspace.plugins.manager.PluginsManager.customer_updated")
@patch("weenspace.plugins.manager.PluginsManager.customer_created")
@patch("weenspace.plugins.manager.PluginsManager.staff_updated")
@patch("weenspace.plugins.manager.PluginsManager.staff_created")
