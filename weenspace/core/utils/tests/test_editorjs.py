...
@pytest.mark.parametrize(
    ...
    [
        ...
        'The Saleor Winter Sale is snowed <a href="https://docs.weenspace.com/docs/">',
        'The Saleor Sale is snowed <a href="https://docs.weenspace.com/docs/">. Test.',
        'The Saleor Winter Sale is snowed <a href="https://docs.weenspace.com/docs/">. '
        'Test <a href="https://docs.weenspace.com/docs/">.',
        "",
...
@mock.patch("weenspace.core.utils.editorjs.parse_url")
        ...
        "blocks": [
            {
                "data": {
                    ...
                    '<a href="https://docs.weenspace.com/docs/">. Test.'
                },
                "type": "paragraph",
            },
            {
                ...
                "data": {
                    ...
                    "items": [
                        ...
                        '<a href="https://docs.weenspace.com/docs/">.',
...
def test_clean_editor_js_for_list_invalid_url(parse_url_mock):
    ...
    url1 = "https://docs.weenspace.com/docs/"
