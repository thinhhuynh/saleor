...
JWT_SALEOR_OWNER_NAME = "weenspace"
...
def is_weenspace_token(token: str) -> bool:
    """Confirm that token was generated by WeenSpace not by plugin."""
    try:
...
def create_access_token_for_app(
    ...
    App can use user's JWT token to proceed given operation in WeenSpace.
