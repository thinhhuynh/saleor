...
@patch(
    "weenspace.product.tasks.update_variant_relations_for_active_promotion_rules_task."
    "delay"
)
...
@patch("weenspace.product.tasks.PROMOTION_RULE_BATCH_SIZE", 1)
...
@patch("weenspace.product.tasks.PROMOTION_RULE_BATCH_SIZE", 1)
@patch("weenspace.product.tasks.recalculate_discounted_price_for_products_task.delay")
@patch("weenspace.product.utils.variants.fetch_variants_for_promotion_rules")
...
@patch("weenspace.product.tasks.update_discounted_prices_for_promotion")
@patch("weenspace.product.tasks.recalculate_discounted_price_for_products_task.delay")
