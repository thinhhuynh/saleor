...
@freeze_time()
@mock.patch("weenspace.webhook.payloads.generate_order_lines_payload")
@mock.patch("weenspace.webhook.payloads.generate_fulfillment_lines_payload")
...
@mock.patch("weenspace.webhook.payloads._generate_order_lines_payload_for_tax_calculation")
...
@patch("weenspace.webhook.payloads.serialize_checkout_lines_for_tax_calculation")
@pytest.mark.parametrize("prices_entered_with_tax", [True, False])
