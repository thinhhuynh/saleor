...
@mock.patch("weenspace.plugins.email_common.send_mail")
...
@mock.patch("weenspace.plugins.user_email.tasks.send_email")
...
@mock.patch(
    "weenspace.plugins.user_email.tasks.account_events.customer_email_changed_event"
)
@mock.patch("weenspace.plugins.email_common.send_mail")
