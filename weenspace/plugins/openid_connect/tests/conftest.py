...
def openid_plugin(settings, plugin_configuration):
    def fun(
        ...
        enable_refresh_token=True,
        oauth_authorization_url="https://weenspace.com/oauth/authorize",
        oauth_token_url="https://weenspace.com/oauth/token",
        ...
        settings.PLUGINS = ["weenspace.plugins.openid_connect.plugin.OpenIDConnectPlugin"]
...
def decoded_access_token():
    return {
        ...
        "aud": ["perms", "https://weenspace.com/userinfo"],
        "iat": 1615374231,
        "exp": 1615460631,
