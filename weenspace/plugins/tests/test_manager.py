...
def test_get_plugins_manager(settings):
    plugin_path = "weenspace.plugins.tests.sample_plugins.PluginSample"
...
def test_manager_with_default_configuration_for_channel_plugins(
    ...
    settings.PLUGINS = [
        "weenspace.plugins.tests.sample_plugins.ChannelPluginSample",
        "weenspace.plugins.tests.sample_plugins.PluginSample",
    ]
    manager = get_plugins_manager(allow_replica=False)
    manager.get_all_plugins()
...
def test_manager_get_plugins_with_channel_slug(
    ...
    settings.PLUGINS = [
        "weenspace.plugins.tests.sample_plugins.PluginInactive",
        "weenspace.plugins.tests.sample_plugins.PluginSample",
    ]
    manager = get_plugins_manager(allow_replica=False)
...
@pytest.mark.parametrize(
    ...
    [(["weenspace.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "15.0")],
)
...
@pytest.mark.parametrize(
    ...
    [(["weenspace.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "0.0")],
)
...
@pytest.mark.parametrize(
    ("plugins", "shipping_amount"),
    [(["weenspace.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "10.0")],
)
...
def test_manager_get_checkout_line_tax_rate_sample_plugin(checkout_with_item):
    plugins = ["weenspace.plugins.tests.sample_plugins.PluginSample"]
...
@pytest.mark.parametrize(
    ("plugins", "amount"),
    [(["weenspace.plugins.tests.sample_plugins.PluginSample"], "1.0"), ([], "12.30")],
)
...
@pytest.mark.parametrize(
    ...
    [
        ([], sample_none_data),
        (["weenspace.plugins.tests.sample_plugins.PluginSample"], sample_tax_data),
    ],
)
...
def test_plugin_add_new_configuration(
    ...
    manager = PluginsManager(
        plugins=["weenspace.plugins.tests.sample_plugins.PluginInactive"]
    )
...
def test_manager_serve_list_of_payment_gateways(channel_USD):
    ...
    plugins = [
        "weenspace.plugins.tests.sample_plugins.PluginSample",
        "weenspace.plugins.tests.sample_plugins.ActivePaymentGateway",
        "weenspace.plugins.tests.sample_plugins.InactivePaymentGateway",
    ]
    manager = PluginsManager(plugins=plugins)
...
def test_manager_serve_list_all_payment_gateways_specified_currency(channel_USD):
    ...
    plugins = [
        "weenspace.plugins.tests.sample_plugins.ActivePaymentGateway",
        "weenspace.plugins.tests.sample_plugins.InactivePaymentGateway",
        "weenspace.plugins.tests.sample_plugins.ActiveDummyPaymentGateway",
    ]
    manager = PluginsManager(plugins=plugins)
    assert (
...
@mock.patch(
    "weenspace.plugins.manager.PluginsManager._PluginsManager__run_method_on_single_plugin"
)
...
def test_run_check_payment_balance(channel_USD):
    plugins = ["weenspace.plugins.tests.sample_plugins.ActiveDummyPaymentGateway"]
...
def test_run_check_payment_balance_not_implemented(channel_USD):
    plugins = ["weenspace.plugins.tests.sample_plugins.ActivePlugin"]
...
@mock.patch("weenspace.plugins.manager.base_calculations.checkout_total")
...
@patch("weenspace.plugins.tests.sample_plugins.PluginSample.checkout_fully_paid")
...
@patch("weenspace.plugins.tests.sample_plugins.PluginSample.order_fully_refunded")
...
@patch("weenspace.plugins.tests.sample_plugins.PluginSample.order_refunded")
...
@patch("weenspace.plugins.tests.sample_plugins.PluginSample.order_paid")
...
@patch("weenspace.plugins.tests.sample_plugins.PluginSample.list_stored_payment_methods")
...
@patch(
    "weenspace.plugins.tests.sample_plugins.PluginSample.stored_payment_method_request_delete"
)
...
def test_get_plugin_invalid_channel():
    ...
    plugin = manager.get_plugin(
        "weenspace.plugins.tests.sample_plugins.PluginSample", channel_slug="invalid"
    )
