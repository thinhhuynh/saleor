...
@patch("weenspace.plugins.sendgrid.tasks.Mail")
@patch("weenspace.plugins.sendgrid.tasks.SendGridAPIClient.send")
def test_send_email(
...
@patch("weenspace.plugins.sendgrid.tasks.send_email")
