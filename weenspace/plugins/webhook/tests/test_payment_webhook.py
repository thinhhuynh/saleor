...
@mock.patch(
    "weenspace.webhook.transport.synchronous.transport.create_delivery_for_subscription_sync_event"
)
@mock.patch("weenspace.webhook.transport.synchronous.transport.send_webhook_request_sync")
...
@mock.patch(
    "weenspace.webhook.transport.synchronous.transport.observability.report_event_delivery_attempt"
)
...
@mock.patch("weenspace.webhook.observability.report_event_delivery_attempt")
@mock.patch.object(HTTPSession, "request")
@mock.patch("weenspace.webhook.transport.synchronous.transport.clear_successful_delivery")
...
@mock.patch("weenspace.webhook.transport.synchronous.transport.send_webhook_request_sync")
@mock.patch("weenspace.plugins.webhook.plugin.generate_list_gateways_payload")
