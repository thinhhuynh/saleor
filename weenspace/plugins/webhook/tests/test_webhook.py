...
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.send_webhook_request_async.delay"
)
...
@mock.patch("weenspace.plugins.webhook.plugin.get_webhooks_for_event")
@mock.patch("weenspace.plugins.webhook.plugin.trigger_webhooks_async")
def test_order_created(
    ...
    settings.PLUGINS = ["weenspace.plugins.webhook.plugin.WebhookPlugin"]
...
def test_create_event_payload_reference_with_error(
    ...
    monkeypatch.setattr(
        "weenspace.webhook.transport.utils.boto3.client",
...
@mock.patch("weenspace.plugins.webhook.plugin.send_webhook_request_async.delay")
...
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.observability.report_event_delivery_attempt"
)
@mock.patch("weenspace.webhook.transport.asynchronous.transport.clear_successful_delivery")
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.send_webhook_using_scheme_method"
)
...
@mock.patch("weenspace.webhook.observability.utils.report_event_delivery_attempt")
@mock.patch("weenspace.webhook.transport.utils.clear_successful_delivery")
...
@freeze_time("1914-06-28 10:50")
@mock.patch("weenspace.plugins.webhook.plugin.get_webhooks_for_event")
@mock.patch("weenspace.plugins.webhook.plugin.trigger_transaction_request")
...
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.send_webhook_request_async.retry"
)
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.observability.report_event_delivery_attempt"
)
