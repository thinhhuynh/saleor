...
@mock.patch("weenspace.webhook.transport.synchronous.transport.cache.set")
@mock.patch("weenspace.webhook.transport.shipping.trigger_webhook_sync")
@mock.patch(
    "weenspace.plugins.webhook.plugin.generate_excluded_shipping_methods_for_order_payload"
)
...
@mock.patch(
    "weenspace.plugins.webhook.plugin.WebhookPlugin.excluded_shipping_methods_for_order"
)
...
@mock.patch(
    "weenspace.plugins.webhook.plugin.WebhookPlugin.excluded_shipping_methods_for_checkout"
)
...
@mock.patch(
    "weenspace.plugins.manager.PluginsManager.excluded_shipping_methods_for_checkout"
)
...
@mock.patch("weenspace.webhook.transport.synchronous.transport.send_webhook_request_sync")
...
@mock.patch("weenspace.webhook.transport.shipping.trigger_webhook_sync")
@mock.patch(
    "weenspace.plugins.webhook.plugin."
    "generate_excluded_shipping_methods_for_checkout_payload"
)
...
@mock.patch("weenspace.webhook.transport.shipping.parse_excluded_shipping_methods")
@mock.patch("weenspace.webhook.transport.shipping.trigger_webhook_sync")
@mock.patch(
    "weenspace.webhook.transport.shipping.get_excluded_shipping_methods_from_response"
)
