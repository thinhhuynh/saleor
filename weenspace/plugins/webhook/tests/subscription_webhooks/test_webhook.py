...
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.create_deliveries_for_subscriptions"
)
...
@mock.patch("weenspace.webhook.transport.synchronous.transport.send_webhook_request_sync")
@mock.patch("weenspace.webhook.transport.synchronous.transport.get_webhooks_for_event")
@mock.patch(
    "weenspace.webhook.transport.synchronous.transport.generate_payload_from_subscription"
)
...
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.send_webhook_request_async"
)
@mock.patch("weenspace.plugins.webhook.plugin.get_webhooks_for_event")
@mock.patch(
    "weenspace.webhook.transport.asynchronous.transport.generate_payload_from_subscription"
)
