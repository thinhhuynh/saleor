...
@mock.patch(
    "weenspace.webhook.transport.synchronous."
...
@freeze_time("2022-06-11 12:50")
@mock.patch("weenspace.plugins.webhook.tasks.handle_transaction_request_task.delay")
...
@freeze_time("2022-06-11 12:50")
@mock.patch("weenspace.webhook.transport.synchronous.transport.handle_webhook_retry")
@mock.patch.object(HTTPSession, "request")
...
@freeze_time("2022-06-11 12:50")
@mock.patch(
    "weenspace.payment.utils.recalculate_transaction_amounts",
