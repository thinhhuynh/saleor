...
@mock.patch(
    "weenspace.plugins.tests.sample_plugins.SampleAuthorizationPlugin.authenticate_user"
)
def test_user_is_cached_on_request(
    ...
    # given
    settings.PLUGINS = ["weenspace.plugins.tests.sample_plugins.SampleAuthorizationPlugin"]
