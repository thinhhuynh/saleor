...
@patch("weenspace.graphql.checkout.mutations.checkout_lines_add.invalidate_checkout")
...
@patch("weenspace.graphql.checkout.mutations.checkout_lines_delete.invalidate_checkout")
...
@patch("weenspace.graphql.checkout.mutations.checkout_line_delete.invalidate_checkout")
...
@patch(
    "weenspace.graphql.checkout.mutations.checkout_shipping_address_update"
    ".invalidate_checkout"
)
...
@patch(
    "weenspace.graphql.checkout.mutations.checkout_billing_address_update"
    ".invalidate_checkout"
)
...
@mock.patch(
    "weenspace.graphql.checkout.mutations.checkout_shipping_method_update."
    "invalidate_checkout",
...
@mock.patch(
    "weenspace.graphql.checkout.mutations.checkout_delivery_method_update."
    "invalidate_checkout",
    wraps=invalidate_checkout,
)
