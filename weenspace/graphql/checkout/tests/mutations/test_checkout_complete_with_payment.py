...
@patch("weenspace.order.calculations._recalculate_with_plugins")
@patch("weenspace.plugins.manager.PluginsManager.order_confirmed")
...
@pytest.mark.integration
@patch("weenspace.graphql.checkout.mutations.checkout_complete.complete_checkout")
...
@patch(
    "weenspace.payment.gateways.dummy_credit_card.plugin."
...
@patch("weenspace.checkout.complete_checkout.gateway.refund")
...
@patch("weenspace.checkout.complete_checkout.gateway.void")
...
@patch("weenspace.checkout.complete_checkout.gateway.payment_refund_or_void")
...
@patch("weenspace.checkout.complete_checkout._create_order")
...
def test_checkout_complete_line_deleted_in_the_meantime(
    ...
    with before_after.before(
        "weenspace.graphql.checkout.mutations.checkout_complete.complete_checkout",
        delete_order_line,
    ):
        response = user_api_client.post_graphql(MUTATION_CHECKOUT_COMPLETE, variables)
