...
@mock.patch(
    "weenspace.graphql.checkout.mutations.checkout_lines_add."
    "update_checkout_shipping_method_if_invalid",
    wraps=update_checkout_shipping_method_if_invalid,
)
@mock.patch(
    "weenspace.graphql.checkout.mutations.checkout_lines_add.invalidate_checkout",
...
@mock.patch("weenspace.plugins.manager.PluginsManager.list_shipping_methods_for_checkout")
