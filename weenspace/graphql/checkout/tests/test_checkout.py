...
@mock.patch("weenspace.plugins.manager.PluginsManager.list_payment_gateways")
...
#         "weenspace.payment.gateway.get_plugins_manager",
#         autospec=True,
...
@mock.patch("weenspace.plugins.manager.PluginsManager.list_stored_payment_methods")
