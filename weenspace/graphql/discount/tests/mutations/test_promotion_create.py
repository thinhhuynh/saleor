...
@patch("weenspace.plugins.manager.PluginsManager.promotion_created")
...
@freeze_time("2020-03-18 12:00:00")
@patch("weenspace.product.tasks.update_products_discounted_prices_of_promotion_task.delay")
@patch("weenspace.plugins.manager.PluginsManager.promotion_started")
@patch("weenspace.plugins.manager.PluginsManager.promotion_created")
