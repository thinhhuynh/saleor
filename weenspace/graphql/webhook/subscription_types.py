...
class Event(graphene.Interface):
    ...
    recipient = graphene.Field(
        "weenspace.graphql.app.types.App",
...
class AccountOperationBase(AbstractType):
    ...
    channel = graphene.Field(
        "weenspace.graphql.channel.types.Channel",
...
class AddressBase(AbstractType):
    address = graphene.Field(
        "weenspace.graphql.account.types.Address",
...
class AttributeBase(AbstractType):
    attribute = graphene.Field(
        "weenspace.graphql.attribute.types.Attribute",
...
class AttributeValueBase(AbstractType):
    attribute_value = graphene.Field(
        "weenspace.graphql.attribute.types.AttributeValue",
...
class CategoryBase(AbstractType):
    category = graphene.Field(
        "weenspace.graphql.product.types.Category",
...
class OrderBase(AbstractType):
    order = graphene.Field(
        "weenspace.graphql.order.types.Order",
...
class GiftCardBase(AbstractType):
    gift_card = graphene.Field(
        "weenspace.graphql.giftcard.types.GiftCard",
...
class GiftCardExportCompleted(SubscriptionObjectType):
    export = graphene.Field(
        "weenspace.graphql.csv.types.ExportFile",
...
class MenuBase(AbstractType):
    menu = graphene.Field(
        "weenspace.graphql.menu.types.Menu",
        channel=graphene.String(
...
class MenuItemBase(AbstractType):
    menu_item = graphene.Field(
        "weenspace.graphql.menu.types.MenuItem",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class ProductBase(AbstractType):
    product = graphene.Field(
        "weenspace.graphql.product.types.Product",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
    ...
    category = graphene.Field(
        "weenspace.graphql.product.types.categories.Category",
...
class ProductMediaBase(AbstractType):
    product_media = graphene.Field(
        "weenspace.graphql.product.types.ProductMedia",
...
class ProductVariantBase(AbstractType):
    product_variant = graphene.Field(
        "weenspace.graphql.product.types.ProductVariant",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class ProductVariantOutOfStock(SubscriptionObjectType, ProductVariantBase):
    warehouse = graphene.Field(
        "weenspace.graphql.warehouse.types.Warehouse", description="Look up a warehouse."
    )
...
class SaleBase(AbstractType):
    sale = graphene.Field(
        "weenspace.graphql.discount.types.Sale",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class PromotionBase(AbstractType):
    promotion = graphene.Field(
        "weenspace.graphql.discount.types.Promotion",
...
class PromotionRuleBase(AbstractType):
    promotion_rule = graphene.Field(
        "weenspace.graphql.discount.types.PromotionRule",
...
class InvoiceBase(AbstractType):
    invoice = graphene.Field(
        "weenspace.graphql.invoice.types.Invoice",
...
class FulfillmentBase(AbstractType):
    fulfillment = graphene.Field(
        "weenspace.graphql.order.types.Fulfillment",
...
class UserBase(AbstractType):
    user = graphene.Field(
        "weenspace.graphql.account.types.User",
        description="The user the event relates to.",
    )
...
class CollectionBase(AbstractType):
    collection = graphene.Field(
        "weenspace.graphql.product.types.collections.Collection",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class CheckoutBase(AbstractType):
    checkout = graphene.Field(
        "weenspace.graphql.checkout.types.Checkout",
...
class PageBase(AbstractType):
    page = graphene.Field(
        "weenspace.graphql.page.types.Page", description="The page the event relates to."
    )
...
class PageTypeBase(AbstractType):
    page_type = graphene.Field(
        "weenspace.graphql.page.types.PageType",
...
class PermissionGroupBase(AbstractType):
    permission_group = graphene.Field(
        "weenspace.graphql.account.types.Group",
...
class ShippingPriceBase(AbstractType):
    shipping_method = graphene.Field(
        "weenspace.graphql.shipping.types.ShippingMethodType",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
    ...
    shipping_zone = graphene.Field(
        "weenspace.graphql.shipping.types.ShippingZone",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class VoucherBase(AbstractType):
    voucher = graphene.Field(
        "weenspace.graphql.discount.types.Voucher",
        channel=graphene.String(
            description="Slug of a channel for which the data should be returned."
        ),
...
class VoucherCodeBase(AbstractType):
    voucher_codes = NonNullList(
        "weenspace.graphql.discount.types.VoucherCode",
...
class PaymentBase(AbstractType):
    payment = graphene.Field(
        "weenspace.graphql.payment.types.Payment",
...
class CalculateTaxes(SubscriptionObjectType):
    tax_base = graphene.Field(
        "weenspace.graphql.core.types.taxes.TaxableObject", required=True
    )
...
class WarehouseBase(AbstractType):
    warehouse = graphene.Field(
        "weenspace.graphql.warehouse.types.Warehouse",
