...
@mock.patch("weenspace.plugins.manager.PluginsManager.transaction_initialize_session")
...
@mock.patch("weenspace.plugins.manager.PluginsManager.checkout_fully_paid")
@mock.patch("weenspace.plugins.manager.PluginsManager.transaction_initialize_session")
