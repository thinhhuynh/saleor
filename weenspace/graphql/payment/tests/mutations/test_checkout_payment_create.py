...
@patch(
    "weenspace.payment.gateways.dummy.plugin.DummyGatewayPlugin.CONFIGURATION_PER_CHANNEL",
    False,
)
...
@patch("weenspace.payment.gateways.dummy.plugin.DummyGatewayPlugin.DEFAULT_ACTIVE", False)
...
def test_checkout_add_payment_run_multiple_times(
    ...
    with before_after.before(
        "weenspace.graphql.payment.mutations.payment."
