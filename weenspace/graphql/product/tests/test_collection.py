...
@patch("weenspace.plugins.manager.PluginsManager.collection_updated")
@patch("weenspace.plugins.manager.PluginsManager.collection_created")
...
@patch("weenspace.core.tasks.delete_from_storage_task.delay")
...
def test_update_collection_invalid_background_image(
    ...
    monkeypatch.setattr(
        "weenspace.graphql.core.validators.file.Image.open", image_file_mock
    )
