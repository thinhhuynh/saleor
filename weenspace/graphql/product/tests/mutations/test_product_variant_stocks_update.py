...
@patch("weenspace.plugins.manager.PluginsManager.product_variant_stock_updated")
@patch("weenspace.plugins.manager.PluginsManager.product_variant_back_in_stock")
