...
@patch("weenspace.plugins.manager.PluginsManager.product_variant_updated")
...
@mock.patch(
    "weenspace.graphql.product.bulk_mutations.product_variant_bulk_update.ProductVariantBulkUpdate.call_event"
)
