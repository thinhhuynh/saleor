...
@patch("weenspace.product.utils.get_webhooks_for_event")
@patch("weenspace.plugins.webhook.plugin.trigger_webhooks_async")
...
@patch("weenspace.product.utils.get_webhooks_for_event")
@patch("weenspace.plugins.manager.PluginsManager.product_updated")
...
@patch(
    "weenspace.graphql.product.bulk_mutations."
    "collection_bulk_delete.get_webhooks_for_event"
)
@patch("weenspace.plugins.manager.PluginsManager.collection_deleted")
...
@patch("weenspace.order.tasks.recalculate_orders_task.delay")
...
@patch("weenspace.product.signals.delete_from_storage_task.delay")
@patch("weenspace.order.tasks.recalculate_orders_task.delay")
...
@patch(
    "weenspace.graphql.product.bulk_mutations.product_variant_bulk_delete.get_webhooks_for_event"
)
@patch("weenspace.plugins.manager.PluginsManager.product_variant_deleted")
@patch("weenspace.order.tasks.recalculate_orders_task.delay")
...
@patch("weenspace.product.signals.delete_from_storage_task")
@patch("weenspace.plugins.manager.PluginsManager.product_variant_deleted")
@patch("weenspace.order.tasks.recalculate_orders_task.delay")
