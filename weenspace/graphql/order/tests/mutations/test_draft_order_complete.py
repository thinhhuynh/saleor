...
@patch("weenspace.plugins.manager.PluginsManager.excluded_shipping_methods_for_order")
...
@freeze_time()
@override_settings(PLUGINS=["weenspace.plugins.webhook.plugin.WebhookPlugin"])
...
@freeze_time()
@patch("weenspace.plugins.tests.sample_plugins.PluginSample.calculate_order_line_total")
