...
@patch("weenspace.plugins.manager.PluginsManager.product_variant_out_of_stock")
...
@patch("weenspace.plugins.manager.PluginsManager.tracking_number_updated")
@patch("weenspace.graphql.order.mutations.order_fulfill.create_fulfillments")
...
@patch(
    "weenspace.graphql.order.mutations.order_fulfill.create_fulfillments", autospec=True
)
...
@patch("weenspace.order.actions.send_fulfillment_confirmation_to_customer", autospec=True)
