...
@patch("weenspace.plugins.manager.PluginsManager.draft_order_updated")
...
@patch("weenspace.order.actions.gateway.refund")
...
@patch("weenspace.plugins.manager.PluginsManager.calculate_order_line_unit")
