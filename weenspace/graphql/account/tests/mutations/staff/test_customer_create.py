...
@patch("weenspace.plugins.manager.PluginsManager.customer_metadata_updated")
@patch("weenspace.account.notifications.default_token_generator.make_token")
@patch("weenspace.plugins.manager.PluginsManager.notify")
@patch("weenspace.plugins.manager.PluginsManager.account_set_password_requested")
