...
@patch("weenspace.graphql.account.mutations.account.request_email_change.create_token")
@patch("weenspace.plugins.manager.PluginsManager.account_change_email_requested")
