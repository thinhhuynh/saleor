...
@patch(
    "weenspace.graphql.account.mutations.account.confirm_email_change.match_orders_with_new_user"
)
@patch(
    "weenspace.graphql.account.mutations.account.confirm_email_change.assign_user_gift_cards"
)
@patch("weenspace.plugins.manager.PluginsManager.account_email_changed")
