...
@patch("weenspace.account.notifications.account_delete_token_generator.make_token")
...
@patch("weenspace.account.notifications.account_delete_token_generator.make_token")
@patch("weenspace.plugins.manager.PluginsManager.account_delete_requested")
