...
@patch(
    "weenspace.graphql.account.mutations.account.confirm_account.assign_user_gift_cards"
)
@patch(
    "weenspace.graphql.account.mutations.account.confirm_account.match_orders_with_new_user"
)
@patch("weenspace.plugins.manager.PluginsManager.account_confirmed")
