...
class CustomerEvent(ModelObjectType[models.CustomerEvent]):
    ...
    order = graphene.Field(
        "weenspace.graphql.order.types.Order", description="The concerned order."
    )
    order_line = graphene.Field(
        "weenspace.graphql.order.types.OrderLine", description="The concerned order line."
    )
...
class User(ModelObjectType[models.User]):
    ...
    gift_cards = ConnectionField(
        "weenspace.graphql.giftcard.types.GiftCardCountableConnection",
    ...
    orders = ConnectionField(
        "weenspace.graphql.order.types.OrderCountableConnection",
        description=(
    ...
    stored_payment_sources = NonNullList(
        "weenspace.graphql.payment.types.PaymentSource",
        description=(
