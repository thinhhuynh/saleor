...
@patch(
    "weenspace.graphql.channel.mutations.channel_update."
...
@patch("weenspace.discount.tasks.decrease_voucher_codes_usage_task.delay")
...
@patch("weenspace.discount.tasks.disconnect_voucher_codes_from_draft_orders_task.delay")
