            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                weenspace.payment.TransactionError("incorrect_number"),
                                "incorrect_number",
                            ),
                            (
                                weenspace.payment.TransactionError("invalid_number"),
                                "invalid_number",
                            ),
                            (
                                weenspace.payment.TransactionError("incorrect_cvv"),
                                "incorrect_cvv",
                            ),
                            (
                                weenspace.payment.TransactionError("invalid_cvv"),
                                "invalid_cvv",
                            ),
                            (
                                weenspace.payment.TransactionError("incorrect_zip"),
                                "incorrect_zip",
                            ),
                            (
                                weenspace.payment.TransactionError("incorrect_address"),
                                "incorrect_address",
                            ),
                            (
                                weenspace.payment.TransactionError("invalid_expiry_date"),
                                "invalid_expiry_date",
                            ),
                            (weenspace.payment.TransactionError("expired"), "expired"),
                            (
                                weenspace.payment.TransactionError("processing_error"),
                                "processing_error",
                            ),
                            (weenspace.payment.TransactionError("declined"), "declined"),
                        ],
                        max_length=256,
                        null=True,
                    ),
