...
@patch("weenspace.payment.utils.update_payment_charge_status")
@patch("weenspace.payment.utils.get_channel_slug_from_payment")
@patch("weenspace.payment.gateway.payment_refund_or_void")
...
@patch("weenspace.plugins.manager.PluginsManager.order_paid")
