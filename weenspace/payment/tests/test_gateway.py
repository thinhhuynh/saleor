...
@patch("weenspace.payment.gateway.update_payment")
...
@patch("weenspace.plugins.manager.PluginsManager.is_event_active_for_any_plugin")
...
@patch("weenspace.plugins.manager.PluginsManager.is_event_active_for_any_plugin")
@patch("weenspace.plugins.manager.PluginsManager.transaction_charge_requested")
...
@patch("weenspace.plugins.manager.PluginsManager.is_event_active_for_any_plugin")
@patch("weenspace.plugins.manager.PluginsManager.transaction_refund_requested")
...
@patch("weenspace.plugins.manager.PluginsManager.is_event_active_for_any_plugin")
@patch("weenspace.plugins.manager.PluginsManager.transaction_cancelation_requested")
