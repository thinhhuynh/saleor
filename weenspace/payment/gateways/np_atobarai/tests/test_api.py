...
@patch("weenspace.payment.gateways.np_atobarai.api_helpers.requests.request")
...
@patch("weenspace.payment.gateways.np_atobarai.api.change_transaction")
@patch.object(HTTPSession, "request")
...
@patch("weenspace.payment.gateways.np_atobarai.notify_dashboard")
@patch("weenspace.payment.gateways.np_atobarai.api.report_fulfillment")
...
@patch("weenspace.payment.gateways.np_atobarai.api.cancel")
@patch.object(HTTPSession, "request")
...
@patch("weenspace.payment.gateways.np_atobarai.api.report")
@patch("weenspace.payment.gateways.np_atobarai.api.register")
@patch("weenspace.payment.gateways.np_atobarai.api.cancel")
