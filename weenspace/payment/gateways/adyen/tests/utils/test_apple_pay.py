...
from weenspace.payment.gateways.adyen.utils.apple_pay import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (None, "merchant.com.identifier", "weenspace.com", "Saleor", "certifiate data"),
        (
            "https://apple-pay-gateway.apple.com/paymentservices/startSession",
            None,
            "weenspace.com",
...
@mock.patch("weenspace.payment.gateways.adyen.utils.apple_pay.NamedTemporaryFile")
