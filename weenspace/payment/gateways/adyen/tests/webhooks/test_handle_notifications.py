...
@mock.patch("weenspace.payment.gateways.adyen.plugin.call_refund")
def test_handle_authorization_for_checkout_out_of_stock_after_payment(
    ...
    with before_after.before(
        "weenspace.checkout.complete_checkout._create_order",
...
@mock.patch("weenspace.payment.gateways.adyen.webhooks.order_refunded")
...
@mock.patch("weenspace.payment.gateways.adyen.webhooks.handle_refund")
...
@mock.patch("weenspace.payment.gateways.adyen.webhooks.handle_cancellation")
...
@patch("weenspace.payment.gateway.void")
@mock.patch("weenspace.payment.gateways.adyen.webhooks.call_refund")
@patch("weenspace.checkout.complete_checkout._get_order_data")
