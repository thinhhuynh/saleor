...
def authorize(
    ...
    # The WeenSpace token is the authorize.net "opaque data"
    ...
    # It is not the WeenSpace user id.
    customer_id = (
...
def _authorize_net_account_to_payment_method_info(
    ...
    """Transform Authorize.Net transactionResponse to WeenSpace credit card.
...
def _normalize_last_4(account_number: str):
    """Convert authorize.net account number to WeenSpace "last_4" format.
