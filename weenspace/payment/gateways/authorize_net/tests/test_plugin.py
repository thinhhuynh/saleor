...
@mock.patch("weenspace.payment.gateways.authorize_net.plugin.authenticate_test")
...
@mock.patch("weenspace.payment.gateways.authorize_net.plugin.refund")
...
@mock.patch("weenspace.payment.gateways.authorize_net.plugin.authorize")
...
@mock.patch("weenspace.payment.gateways.authorize_net.plugin.capture")
...
@mock.patch("weenspace.payment.gateways.authorize_net.plugin.process_payment")
...
@mock.patch("weenspace.payment.gateways.authorize_net.plugin.list_client_sources")
