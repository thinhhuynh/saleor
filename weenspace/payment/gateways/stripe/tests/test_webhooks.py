...
@patch(
    "weenspace.payment.gateways.stripe.webhooks.complete_checkout", wraps=complete_checkout
)
@patch("weenspace.payment.gateways.stripe.webhooks.update_payment_method")
...
@patch("weenspace.payment.gateway.refund")
...
@patch("weenspace.payment.gateway.refund")
@patch("weenspace.checkout.complete_checkout._get_order_data")
...
@patch(
    "weenspace.payment.gateways.stripe.webhooks._process_payment_with_checkout",
...
@pytest.mark.parametrize("called", [True, False])
@patch("weenspace.payment.gateways.stripe.webhooks.order_charged", wraps=order_charged)
@patch("weenspace.payment.gateways.stripe.webhooks.update_payment_method")
...
@patch("weenspace.payment.gateway.void")
...
@pytest.mark.parametrize("called", [True, False])
@patch(
    "weenspace.payment.gateways.stripe.webhooks._update_payment_with_new_transaction",
...
@patch("weenspace.payment.gateways.stripe.webhooks.order_voided", wraps=order_voided)
...
@patch("weenspace.payment.gateways.stripe.webhooks.stripe.Charge.retrieve")
...
@patch(
    "weenspace.payment.gateways.stripe.webhooks.order_refunded",
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.Webhook.construct_event")
def test_handle_webhook_events(
    ...
    with patch(f"weenspace.payment.gateways.stripe.webhooks.{fun_to_mock}") as mocked_fun:
...
@patch("weenspace.payment.gateways.stripe.plugin.retrieve_payment_intent")
@patch(
    "weenspace.payment.gateways.stripe.webhooks.complete_checkout", wraps=complete_checkout
)
@patch("weenspace.payment.gateways.stripe.webhooks.update_payment_method")
def test_handle_successful_payment_intent_for_checkout_when_already_processing_checkout(
    ...
    with before_after.after(
        "weenspace.checkout.complete_checkout._process_payment",
