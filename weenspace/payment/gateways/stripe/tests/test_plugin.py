...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.WebhookEndpoint.list")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.WebhookEndpoint.delete")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.WebhookEndpoint.create")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.Customer.create")
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.PaymentIntent.create")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.PaymentIntent.retrieve")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.PaymentIntent.capture")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.Refund.create")
...
@patch("weenspace.payment.gateways.stripe.stripe_api.stripe.PaymentIntent.cancel")
